...
//  SwiftyOnboard
//
//  Created by Jay on 3/25/17. Edited by WouterJanson
...
open class SwiftyOnboardPage: UIView {
    ...
    func set(style: SwiftyOnboardStyle) {
        ...
        case .gildt:
            title.textColor = .black
            subTitle.textColor = UIColor.appLightGray
        }
    ...
    func setUp() {
        ...
        subTitle.leftAnchor.constraint(equalTo: margin.leftAnchor, constant: 8).isActive = true
        subTitle.rightAnchor.constraint(equalTo: margin.rightAnchor, constant: -8).isActive = true
        subTitle.topAnchor.constraint(equalTo: title.bottomAnchor, constant: 0).isActive = true
        subTitle.bottomAnchor.constraint(equalTo: margin.bottomAnchor, constant: -60).isActive = true
        subTitle.heightAnchor.constraint(equalToConstant: 120).isActive = true
    }
}
