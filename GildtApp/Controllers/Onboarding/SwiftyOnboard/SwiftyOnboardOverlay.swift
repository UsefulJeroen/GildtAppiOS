...
//  SwiftyOnboard
//
//  Created by Jay on 3/26/17. Edited by WouterJanson
...
open class SwiftyOnboardOverlay: UIView {
    ...
    open func set(style: SwiftyOnboardStyle) {
        ...
        case .gildt:
            continueButton.setTitleColor(.primaryGildtGreen, for: .normal)
            skipButton.setTitleColor(.primaryGildtGreen, for: .normal)
            pageControl.currentPageIndicatorTintColor = .primaryGildtGreen
        }
    }
