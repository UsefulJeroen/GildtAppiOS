...
//  AlertViewController
//
//  Created by Michael Inger on 26/07/2017. Edited by Wouter Janson
...
class UIImageAlertController: UIAlertController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        imageView.center.y = 22 + linesCount * lineHeight / 2.0
        super.viewDidLayoutSubviews()
    }
    ...
    private func newLinesCount(for imageView: UIImageView) -> CGFloat {
        return floor(imageView.bounds.height / lineHeight)
    }
